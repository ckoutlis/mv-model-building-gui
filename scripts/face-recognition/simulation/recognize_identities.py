...
# identities that exist in database: pick an instance not considered when creating the identity's embedding
fps_in = {n: [f'{imgdir}{x}' for x in identities[n]][6] for n in names_in}

# identities that do not exist in database: pick the first instance
fps_out = {n: [f'{imgdir}{x}' for x in identities[n]][0] for n in names_out}
